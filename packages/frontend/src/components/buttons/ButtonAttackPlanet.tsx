...
function ButtonAttackPlanet({
  ...
  const { writeAsync: attack, tx: attackTx } = useSendFleet(
    fleet,
    destinationPosition,
  ...
  const { writeAsync: transport, tx: transportTx } = useSendFleet(
    fleet,
    destinationPosition,
        ...
        <>
          ...
          {isButtotClicked && (
            <TransactionStatus
              ...
              tx={
                noRequirements
                  ? transportTx?.transaction_hash.toString()
                  : attackTx?.transaction_hash.toString()
              }
            />
          )}
        </>
