...
// Create a styled div instead
export const CustomInputContainer = styled("div")({
  backgroundColor: "#625f63",
  width: "6px",
});

// We'll need to use the Input component directly with the CustomInputContainer
// Example usage: <CustomInputContainer><Input /></CustomInputContainer>
