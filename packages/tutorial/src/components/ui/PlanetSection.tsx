...
import planetImg from "../../assets/6.png";
...
const PlanetImage = ({ planetId }: TutorialProps) => {
  return (
    <>
      <PlanetImageWrapper>
        <img
      ...
      <PlanetInfoContainer>
        <PlanetInfoRow label="Size" value={"190"} />
        <PlanetInfoRow label="Name" value={"Nova Luna Terra Sol"} />
        <PlanetInfoRow label="Avg Temp" value={"30"} />
        <PlanetPositionGroup>
          <RadarTextStyle>
            <PlanetInfoKey>PLANET POSITION</PlanetInfoKey>
            <PlanetPositionRowStyled>
              <PlanetInfoRow label="System" value={"15"} />
              <PlanetInfoRow label="Orbit" value={"6"} />
            </PlanetPositionRowStyled>
          </RadarTextStyle>
        </PlanetPositionGroup>
      </PlanetInfoContainer>
...
export const PlanetSection = ({ planetId }: TutorialProps) => (
  <DebugRowCentered>
    <MainContainer>
